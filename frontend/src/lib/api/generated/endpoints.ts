...
import type {
	...
	CheckoutResponse,
	ComplaintCreate,
	DemonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostParams,
	ErrorModel,
...
export type getInvoiceApiV1TransactionsTransactionIdInvoiceGetResponse200 = {
	data: string;
	status: 200;
};

export type getInvoiceApiV1TransactionsTransactionIdInvoiceGetResponse422 = {
	data: HTTPValidationError;
	status: 422;
};

export type getInvoiceApiV1TransactionsTransactionIdInvoiceGetResponseSuccess =
	getInvoiceApiV1TransactionsTransactionIdInvoiceGetResponse200 & {
		headers: Headers;
	};
export type getInvoiceApiV1TransactionsTransactionIdInvoiceGetResponseError =
	getInvoiceApiV1TransactionsTransactionIdInvoiceGetResponse422 & {
		headers: Headers;
	};

export type getInvoiceApiV1TransactionsTransactionIdInvoiceGetResponse =
	| getInvoiceApiV1TransactionsTransactionIdInvoiceGetResponseSuccess
	| getInvoiceApiV1TransactionsTransactionIdInvoiceGetResponseError;

export const getGetInvoiceApiV1TransactionsTransactionIdInvoiceGetUrl = (transactionId: number) => {
	return `/api/v1/transactions/${transactionId}/invoice`;
};
 ...
 * @summary Get Invoice
 */
export const getInvoiceApiV1TransactionsTransactionIdInvoiceGet = async (
	transactionId: number,
	options?: RequestInit
): Promise<getInvoiceApiV1TransactionsTransactionIdInvoiceGetResponse> => {
	return customInstance<getInvoiceApiV1TransactionsTransactionIdInvoiceGetResponse>(
		getGetInvoiceApiV1TransactionsTransactionIdInvoiceGetUrl(transactionId),
		{
			...options,
			method: 'GET'
		}
...
export const getGetInvoiceApiV1TransactionsTransactionIdInvoiceGetQueryKey = (
	transactionId: number
) => {
	return [`/api/v1/transactions/${transactionId}/invoice`] as const;
};

export const getGetInvoiceApiV1TransactionsTransactionIdInvoiceGetQueryOptions = <
	TData = Awaited<ReturnType<typeof getInvoiceApiV1TransactionsTransactionIdInvoiceGet>>,
	TError = HTTPValidationError
>(
	transactionId: number,
	options?: {
		query?: Partial<
			CreateQueryOptions<
				Awaited<ReturnType<typeof getInvoiceApiV1TransactionsTransactionIdInvoiceGet>>,
				TError,
				TData
			>
		>;
	...
	const queryKey =
		queryOptions?.queryKey ??
		getGetInvoiceApiV1TransactionsTransactionIdInvoiceGetQueryKey(transactionId);

	const queryFn: QueryFunction<
		Awaited<ReturnType<typeof getInvoiceApiV1TransactionsTransactionIdInvoiceGet>>
	> = ({ signal }) =>
		getInvoiceApiV1TransactionsTransactionIdInvoiceGet(transactionId, {
			signal,
			...requestOptions
		});
...
export type GetInvoiceApiV1TransactionsTransactionIdInvoiceGetQueryResult = NonNullable<
	Awaited<ReturnType<typeof getInvoiceApiV1TransactionsTransactionIdInvoiceGet>>
>;
export type GetInvoiceApiV1TransactionsTransactionIdInvoiceGetQueryError = HTTPValidationError;

/**
 * @summary Get Invoice
 */

export function createGetInvoiceApiV1TransactionsTransactionIdInvoiceGet<
	TData = Awaited<ReturnType<typeof getInvoiceApiV1TransactionsTransactionIdInvoiceGet>>,
	TError = HTTPValidationError
>(
	transactionId: () => number,
	...
	const query = createQuery(
		() =>
			getGetInvoiceApiV1TransactionsTransactionIdInvoiceGetQueryOptions(
				transactionId(),
				options?.()
			),
		queryClient
...
export type demonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostResponse200 = {
	data: unknown;
	status: 200;
};

export type demonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostResponse422 = {
	data: HTTPValidationError;
	status: 422;
};

export type demonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostResponseSuccess =
	demonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostResponse200 & {
		headers: Headers;
	};
export type demonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostResponseError =
	demonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostResponse422 & {
		headers: Headers;
	};

export type demonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostResponse =
	| demonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostResponseSuccess
	| demonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostResponseError;

export const getDemonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostUrl = (
	params?: DemonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostParams
) => {
	const normalizedParams = new URLSearchParams();
	...
	return stringifiedParams.length > 0
		? `/api/v1/lab/api/lab/demo-adapter?${stringifiedParams}`
		: `/api/v1/lab/api/lab/demo-adapter`;
};

/**
 * @summary Demonstrate Db Adapters
 */
export const demonstrateDbAdaptersApiV1LabApiLabDemoAdapterPost = async (
	params?: DemonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostParams,
	options?: RequestInit
): Promise<demonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostResponse> => {
	return customInstance<demonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostResponse>(
		getDemonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostUrl(params),
		{
			...options,
			method: 'POST'
		}
...
export const getDemonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostMutationOptions = <
	TError = HTTPValidationError,
	TContext = unknown
>(options?: {
	mutation?: CreateMutationOptions<
		Awaited<ReturnType<typeof demonstrateDbAdaptersApiV1LabApiLabDemoAdapterPost>>,
		TError,
		{ params?: DemonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostParams },
		TContext
	>;
	...
	TContext
> => {
	const mutationKey = ['demonstrateDbAdaptersApiV1LabApiLabDemoAdapterPost'];
	const { mutation: mutationOptions, request: requestOptions } = options
		? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
			? options
			: { ...options, mutation: { ...options.mutation, mutationKey } }
	...
	> = (props) => {
		...
		return demonstrateDbAdaptersApiV1LabApiLabDemoAdapterPost(params, requestOptions);
	};

	return { mutationFn, ...mutationOptions };
};

export type DemonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostMutationResult = NonNullable<
	Awaited<ReturnType<typeof demonstrateDbAdaptersApiV1LabApiLabDemoAdapterPost>>
>;

export type DemonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostMutationError = HTTPValidationError;

/**
 * @summary Demonstrate Db Adapters
 */
export const createDemonstrateDbAdaptersApiV1LabApiLabDemoAdapterPost = <
	TError = HTTPValidationError,
	TContext = unknown
>(
	options?: () => {
...
> => {
	return createMutation(
		() => ({
			...getDemonstrateDbAdaptersApiV1LabApiLabDemoAdapterPostMutationOptions(options?.())
		}),
		queryClient
	);
};

export type calculateFeeApiV1LabApiLabCalculateFeePostResponse200 = {
	data: unknown;
	status: 200;
};

export type calculateFeeApiV1LabApiLabCalculateFeePostResponse422 = {
	data: HTTPValidationError;
	status: 422;
};

export type calculateFeeApiV1LabApiLabCalculateFeePostResponseSuccess =
	calculateFeeApiV1LabApiLabCalculateFeePostResponse200 & {
		headers: Headers;
	};
export type calculateFeeApiV1LabApiLabCalculateFeePostResponseError =
	calculateFeeApiV1LabApiLabCalculateFeePostResponse422 & {
		headers: Headers;
	};

export type calculateFeeApiV1LabApiLabCalculateFeePostResponse =
	| calculateFeeApiV1LabApiLabCalculateFeePostResponseSuccess
	| calculateFeeApiV1LabApiLabCalculateFeePostResponseError;

export const getCalculateFeeApiV1LabApiLabCalculateFeePostUrl = () => {
	return `/api/v1/lab/api/lab/calculate-fee`;
};

/**
 * @summary Calculate Fee
 */
export const calculateFeeApiV1LabApiLabCalculateFeePost = async (
	calculateFeeRequest: CalculateFeeRequest,
	options?: RequestInit
): Promise<calculateFeeApiV1LabApiLabCalculateFeePostResponse> => {
	return customInstance<calculateFeeApiV1LabApiLabCalculateFeePostResponse>(
		getCalculateFeeApiV1LabApiLabCalculateFeePostUrl(),
		{
			...options,
			method: 'POST',
			headers: { 'Content-Type': 'application/json', ...options?.headers },
			body: JSON.stringify(calculateFeeRequest)
		}
	);
};

export const getCalculateFeeApiV1LabApiLabCalculateFeePostMutationOptions = <
	TError = HTTPValidationError,
	TContext = unknown
>(options?: {
	mutation?: CreateMutationOptions<
		Awaited<ReturnType<typeof calculateFeeApiV1LabApiLabCalculateFeePost>>,
		TError,
	...
	TContext
> => {
	const mutationKey = ['calculateFeeApiV1LabApiLabCalculateFeePost'];
	const { mutation: mutationOptions, request: requestOptions } = options
		? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
			? options
			: { ...options, mutation: { ...options.mutation, mutationKey } }
	...
	> = (props) => {
		...
		return calculateFeeApiV1LabApiLabCalculateFeePost(data, requestOptions);
	};

	return { mutationFn, ...mutationOptions };
};

export type CalculateFeeApiV1LabApiLabCalculateFeePostMutationResult = NonNullable<
	Awaited<ReturnType<typeof calculateFeeApiV1LabApiLabCalculateFeePost>>
>;
export type CalculateFeeApiV1LabApiLabCalculateFeePostMutationBody = CalculateFeeRequest;
export type CalculateFeeApiV1LabApiLabCalculateFeePostMutationError = HTTPValidationError;

/**
 * @summary Calculate Fee
 */
export const createCalculateFeeApiV1LabApiLabCalculateFeePost = <
	TError = HTTPValidationError,
	TContext = unknown
>(
	options?: () => {
...
> => {
	return createMutation(
		() => ({ ...getCalculateFeeApiV1LabApiLabCalculateFeePostMutationOptions(options?.()) }),
		queryClient
	);
};

export type createCheckoutSessionApiV1PaymentsCreateCheckoutSessionPostResponse200 = {
	data: CheckoutResponse;
	status: 200;
};

export type createCheckoutSessionApiV1PaymentsCreateCheckoutSessionPostResponse422 = {
	data: HTTPValidationError;
	status: 422;
};

export type createCheckoutSessionApiV1PaymentsCreateCheckoutSessionPostResponseSuccess =
	createCheckoutSessionApiV1PaymentsCreateCheckoutSessionPostResponse200 & {
		headers: Headers;
	};
export type createCheckoutSessionApiV1PaymentsCreateCheckoutSessionPostResponseError =
	createCheckoutSessionApiV1PaymentsCreateCheckoutSessionPostResponse422 & {
		headers: Headers;
	};

export type createCheckoutSessionApiV1PaymentsCreateCheckoutSessionPostResponse =
	| createCheckoutSessionApiV1PaymentsCreateCheckoutSessionPostResponseSuccess
	| createCheckoutSessionApiV1PaymentsCreateCheckoutSessionPostResponseError;

export const getCreateCheckoutSessionApiV1PaymentsCreateCheckoutSessionPostUrl = () => {
	return `/api/v1/payments/create-checkout-session`;
};

/**
 * @summary Create Checkout Session
 */
export const createCheckoutSessionApiV1PaymentsCreateCheckoutSessionPost = async (
	checkoutRequest: CheckoutRequest,
	options?: RequestInit
): Promise<createCheckoutSessionApiV1PaymentsCreateCheckoutSessionPostResponse> => {
	return customInstance<createCheckoutSessionApiV1PaymentsCreateCheckoutSessionPostResponse>(
		getCreateCheckoutSessionApiV1PaymentsCreateCheckoutSessionPostUrl(),
		{
			...options,
			method: 'POST',
			headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getCreateCheckoutSessionApiV1PaymentsCreateCheckoutSessionPostMutationOptions = <
	TError = HTTPValidationError,
	TContext = unknown
>(options?: {
	mutation?: CreateMutationOptions<
		Awaited<ReturnType<typeof createCheckoutSessionApiV1PaymentsCreateCheckoutSessionPost>>,
		TError,
	...
	TContext
> => {
	const mutationKey = ['createCheckoutSessionApiV1PaymentsCreateCheckoutSessionPost'];
	const { mutation: mutationOptions, request: requestOptions } = options
		? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
			? options
			: { ...options, mutation: { ...options.mutation, mutationKey } }
	...
	> = (props) => {
		...
		return createCheckoutSessionApiV1PaymentsCreateCheckoutSessionPost(data, requestOptions);
	};

	return { mutationFn, ...mutationOptions };
};

export type CreateCheckoutSessionApiV1PaymentsCreateCheckoutSessionPostMutationResult = NonNullable<
	Awaited<ReturnType<typeof createCheckoutSessionApiV1PaymentsCreateCheckoutSessionPost>>
>;
export type CreateCheckoutSessionApiV1PaymentsCreateCheckoutSessionPostMutationBody =
	CheckoutRequest;
export type CreateCheckoutSessionApiV1PaymentsCreateCheckoutSessionPostMutationError =
	HTTPValidationError;

/**
 * @summary Create Checkout Session
 */
export const createCreateCheckoutSessionApiV1PaymentsCreateCheckoutSessionPost = <
	TError = HTTPValidationError,
	TContext = unknown
>(
	options?: () => {
...
> => {
	return createMutation(
		() => ({
			...getCreateCheckoutSessionApiV1PaymentsCreateCheckoutSessionPostMutationOptions(options?.())
		}),
		queryClient
	);
};

export type stripeWebhookApiV1PaymentsWebhookPostResponse200 = {
	data: unknown;
	status: 200;
};

export type stripeWebhookApiV1PaymentsWebhookPostResponseSuccess =
	stripeWebhookApiV1PaymentsWebhookPostResponse200 & {
		headers: Headers;
	};
export type stripeWebhookApiV1PaymentsWebhookPostResponse =
	stripeWebhookApiV1PaymentsWebhookPostResponseSuccess;

export const getStripeWebhookApiV1PaymentsWebhookPostUrl = () => {
 ...
 */
export const stripeWebhookApiV1PaymentsWebhookPost = async (
	options?: RequestInit
): Promise<stripeWebhookApiV1PaymentsWebhookPostResponse> => {
	return customInstance<stripeWebhookApiV1PaymentsWebhookPostResponse>(
		getStripeWebhookApiV1PaymentsWebhookPostUrl(),
		{
			...options,
			method: 'POST'
		}
...
export const getStripeWebhookApiV1PaymentsWebhookPostMutationOptions = <
	TError = unknown,
	TContext = unknown
>(options?: {
	mutation?: CreateMutationOptions<
		Awaited<ReturnType<typeof stripeWebhookApiV1PaymentsWebhookPost>>,
		TError,
		void,
		TContext
	>;
	...
	TContext
> => {
	const mutationKey = ['stripeWebhookApiV1PaymentsWebhookPost'];
	const { mutation: mutationOptions, request: requestOptions } = options
		? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
			? options
			: { ...options, mutation: { ...options.mutation, mutationKey } }
	...
	const mutationFn: MutationFunction<
		...
		void
	> = () => {
		return stripeWebhookApiV1PaymentsWebhookPost(requestOptions);
	};

	return { mutationFn, ...mutationOptions };
};

export type StripeWebhookApiV1PaymentsWebhookPostMutationResult = NonNullable<
	Awaited<ReturnType<typeof stripeWebhookApiV1PaymentsWebhookPost>>
>;

export type StripeWebhookApiV1PaymentsWebhookPostMutationError = unknown;

/**
 * @summary Stripe Webhook
 */
export const createStripeWebhookApiV1PaymentsWebhookPost = <TError = unknown, TContext = unknown>(
	options?: () => {
		mutation?: CreateMutationOptions<
			Awaited<ReturnType<typeof stripeWebhookApiV1PaymentsWebhookPost>>,
			TError,
...
> => {
	return createMutation(
		() => ({ ...getStripeWebhookApiV1PaymentsWebhookPostMutationOptions(options?.()) }),
		queryClient
	);
};
